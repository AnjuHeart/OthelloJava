...
public class PassFrame extends javax.swing.JFrame {
    ...
    public void setlblPlayer(int i, boolean Second){
        if(Second){
            lblPlayer.setText("Jugador " + String.valueOf(i));
        }
        else{
            if(i == 2){
                lblPlayer.setText("Bot / Máquina");
            }
        }
    }
    ...
    private void initComponents() {
        ...
        setUndecorated(true);
        setPreferredSize(new java.awt.Dimension(225, 180));
        setResizable(false);

        lblPASS.setFont(new java.awt.Font("Segoe UI", 0, 64)); // NOI18N
